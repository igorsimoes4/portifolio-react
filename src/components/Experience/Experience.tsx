                    ...
                    <div className=" bg-white rounded-xl shadow-md overflow-hidden">
                        <div className="w-full flex flex-col lg:flex-row">
                            <div className="lg:w-1/4 w-full sm:justify-center flex justify-center">
                                <img src="https://scontent.fpoa47-1.fna.fbcdn.net/v/t39.30808-6/295340970_1999801200211811_6667735421717615039_n.jpg?_nc_cat=109&ccb=1-7&_nc_sid=5f2048&_nc_eui2=AeEVfkAwLYka_0T7OumS7P7Y82gfMZx384LzaB8xnHfzgkI8m4OnrVE_whR2rI-lsUXuf_FYlUsReGzAuT2YysCX&_nc_ohc=tDgfoMQ_SV8AX_noRyF&_nc_ht=scontent.fpoa47-1.fna&oh=00_AfAg5oWnA6ICOXmqK23KElbkfPwHz2HACgyyncweCB4b6w&oe=65618807" alt="" className=" w-[100%] p-1 justify-center items-center" />                                    
                            </div>
                            <div className="lg:w-3/4 w-full p-8">                            
                                <h3 className="block mt-1 text-lg leading-tight font-medium text-black">Técnico de TI</h3>
                                <p className="mt-2 text-slate-600">Associação Servos da Caridade - Escola São Luís Guanella</p>
                                <p className=" text-slate-600">maio de 2017 - outubro de 2022 · 5 anos 6 meses</p>
                                <p className=" text-slate-600">Porto Alegre, Rio Grande do Sul, Brasil · Presencial</p>
                                <p className="mt-2 text-slate-800 text-justify indent-3">Eu era responsável pela administração do site da empresa, utilizando HTML5, CSS3, JavaScript,
